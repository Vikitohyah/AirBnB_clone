...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, arg):
        '''
        Prints all of the  string representation of all instances
    ...
    def precmd(self, arg):
        """
        Instructs to execute before arguments are interpreted
        """
        if not arg:
            return '\n'
